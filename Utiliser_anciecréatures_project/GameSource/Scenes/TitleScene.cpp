...
void TitleScene::Enter() {
	...
	std::shared_ptr<Transform> playerTransform = std::make_shared<Transform>(Library::float3(320.0f, 100.0f, 0.0f), Library::float3(1.0f, 1.0f, 1.0f), Library::float3(0.0f, 0.0f, 0.0f));
